...
if ($Script:IsAzureAutomation) {
    ...
    $Script:BlobConfig = @{
        ...
        SubscriptionId           = $Script:LocalConfig.ContentEng_SubscriptionId
        StatisticsTableName      = "IncidentsCategoryStats"
    }
...
function Get-TrendSubcategoryRules {
    ...
    $templateText = Get-PromptTemplate -TemplateName 'TrendSubCategorisation_ContentEngineering'
    $rules = @{
        Allowlists = @{}
        AliasMap   = @{}
        AliasesByProduct = @{}
...
try {
    ...
    $Script:TrendCatTemplate    = Get-PromptTemplate -TemplateName 'TicketCategorisation_ContentEngineering'
    $Script:TrendEnvTemplate    = Get-PromptTemplate -TemplateName 'EnvironmentContext_ContentEngineering'
    $Script:TrendSubCatTemplate = Get-PromptTemplate -TemplateName 'TrendSubCategorisation_ContentEngineering'
    $Script:TrendPrcTemplate    = Get-PromptTemplate -TemplateName 'PossibleRootCause_ContentEngineering'
