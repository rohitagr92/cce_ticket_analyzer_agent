...
- **Yammer Access Issue** — User cannot access, sign in to, or use Viva Engage (Yammer). - **Yammer Community Management Issue** 
— User experiences issues creating, managing, administering, or maintaining Viva Engage communities. 
